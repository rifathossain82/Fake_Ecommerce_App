class Message {
  ...
  static const String emptyAmount = "Amount is required!";
  static const String invalidAmount = "Amount is invalid!";
  static const String emptyNumber = "Number is required!";
  static const String invalidNumber = "Number is invalid!";
  static const String fullPaymentRequired = "Full payment required!";
  static const String emptyField = 'This field is required!';
  static const String emptyContactType = 'Contact Type is required!';
  static const String emptyContactName = 'Contact Name is required!';
  static const String emptyCategory = 'Category is required!';
  static const String emptyPaymentMethod = 'Payment Method is required!';
  static const String incorrectBusinessName = 'Incorrect Business Name!';
